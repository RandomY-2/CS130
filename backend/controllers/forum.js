...
module.exports.addComment = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ message: 'Comment added successfully', comment: content, userId })
  } catch (error) {
...
module.exports.addOrUpdateForumRating = async (req, res) => {
  ...
  try {
    ...
    await userAccessForumRef.set({ rating }, { merge: true })
    ...
    return res.status(200).json({ message: 'Rating added/updated successfully', forumRating })
  } catch (error) {
